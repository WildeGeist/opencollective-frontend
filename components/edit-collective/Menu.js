...
const SECTION_LABELS = defineMessages({
  ...
  [EDIT_COLLECTIVE_SECTIONS.RECEIVED_ORDERS]: {
    id: 'editCollective.receivedOrders',
    defaultMessage: 'Received orders',
  },
...
const sectionsDisplayConditions = {
  ...
  [EDIT_COLLECTIVE_SECTIONS.RECEIVED_ORDERS]: () => false,
    ...
    <Flex width={0.2} flexDirection="column" mr={4} mb={3} flexWrap="wrap" css={{ flexGrow: 1, minWidth: 175 }}>
      ...
      {collective.isHost && (
        <Fragment>
          ...
          {renderMenuItem(getSectionInfo(EDIT_COLLECTIVE_SECTIONS.RECEIVED_ORDERS))}
